function FluidSub(image_div, image_height, image_width,
    ...
    var plot_height = 0.9 * image_height;
    var y_offset = 0.05 * image_height;
    var x_offset = 0.3 * image_width; // space for axis

    var intervals = [];
    
    var rock_width = 0.2 * image_width;
    var fluid_width = 0.2 * image_width;
    ...
    // layering order
    var rock_offset = 0.3 * image_width;
  ...
  function create_menu(){
    ...
    var fluidsub_div = div.append("div").attr("class", "col-sm-4")
