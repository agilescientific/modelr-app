...
def rhogas(gravity, temp, pressure):
    ...
    tmp = 0.03 + 0.00527 * (3.5 - tpr)
    z = ppr * tmp + (0.642*tpr - 0.007*tpr**4.0 - 0.52) + bige
...
def smith_fluidsub(vp, vs, rho, phi, rhow, rhohc,
    ...
    Example
        ...
        # Rock properties
        vp_gas = 2429.0      # Rock - initial
        vs_gas = 1462.4      # Rock - initial
        rho_gas = 2080.      # Rock - initial
        phi = 0.30           # Rock
        vclay = 0.0          # Rock
        kclay = 25000000000. # Rock - default
        kqtz = 37000000000.  # Rock - default

        # Fluid properties
        rhohc = 250.         # Fluid - default
        rhow = 1040.         # Fluid - default
        khc = 207000000.     # Fluid - default
        kw = 2950000000.     # Fluid - default
        sw = 0.3             # Fluid
        swnew = 0.           # Fluid - depends on fluid sub scenario
    ...
    # Step 9: Calculate the new saturated bulk modulus
    # of the rock using Gassmann
